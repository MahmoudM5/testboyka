...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MahmoudM5/soon/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1366055467,1593178008}   
...
{'تنظيف الجروبات 𖡞','تنظيف المشتركين 𖡞'},
...
os.execute('wget https://raw.githubusercontent.com/MahmoudM5/soon/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' 𖡞 تم تحديث السورس \n 𖡞 لديك اخر اصدار لسورس سون\n 𖡞 الاصدار » { v 1.5}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار 𖡞' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 𖡞 اصدار سورس سون \n 𖡞 الاصدار »{ v 1.5}')
end
if text == 'مبرمج باندا' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
if text == 'الجروبات 𖡞' and DevSoFi(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n 𖡞 الجروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == "تنظيف الجروبات 𖡞" and DevSoFi(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'𖡞  عدد الجروبات الان » { '..#group..' }'..DRAGONk..''..DRAGON..'\n𖡞  الان عدد الجروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
send(msg.chat_id_, msg.id_,' 𖡞 تم تغيير صورة الجروب')
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
send(msg.chat_id_, msg.id_,' 𖡞 تم تغيير وصف الجروب')
return false  
end 
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖡞 تم حفظ ترحيب الجروب')
return false   
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖡞 عدد اعضاء الجروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖡞 بالتأكيد تم تفعيل الجروب')
else
sendText(msg.chat_id_,'\n 𖡞 بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖡞 تم تفعيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
'\n 𖡞 بواسطة {'..Name..'}'..
'\n 𖡞 ايدي الجروب {'..IdChat..'}'..
'\n 𖡞 اسم الجروب {['..NameChat..']}'..
'\n 𖡞 عدد اعضاء الجروب *{'..NumMember..'}*'..
'\n 𖡞 الرابط {['..LinkGp..']}'
...
send(msg.chat_id_, msg.id_,' 𖡞 بالتأكيد تم تعطيل الجروب')
else
sendText(msg.chat_id_,'\n 𖡞 بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖡞 تم تعطيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖡞 تم تفعيل الجروب')
else
sendText(msg.chat_id_,'\n 𖡞 بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖡞 تم تفعيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,' 𖡞 تم تعيين عدد الاعضاء سيتم تفعيل الجروبات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
...
if Text and Text:match('(.*)/help1') and Mod(tahaj) then
...
if Text and Text:match('(.*)/help2') and Mod(tahaj) then
...
if Text and Text:match('(.*)/help3') and Mod(tahaj) then
...
if Text and Text:match('(.*)/help') and Mod(tahaj) then
...
if Text and Text:match('(.*)/lockdul') and Mod(data) then
...
elseif Text and Text:match('(.*)/lock_links') and Mod(data) then
...
elseif Text and Text:match('(.*)/lockwelcome') and Mod(data) then
...
elseif Text and Text:match('(.*)/lockide') and Mod(data) then
...
elseif Text and Text:match('(.*)/lockidephoto') and Mod(data) then
...
elseif Text and Text:match('(.*)/lockkikedme') and Mod(data) then
...
elseif Text and Text:match('(.*)/lockgames') and Mod(data) then
...
elseif Text and Text:match('(.*)/lockrepgr') and Mod(data) then
...
if Text and Text:match('(.*)/unlockdul') and Mod(data) then
...
elseif Text and Text:match('(.*)/unlock_links') and Mod(data) then
...
elseif Text and Text:match('(.*)/unlockwelcome') and Mod(data) then
...
elseif Text and Text:match('(.*)/unlockrepall') and Mod(data) then
...
elseif Text and Text:match('(.*)/unlockide') and Mod(data) then
...
elseif Text and Text:match('(.*)/unlockidephoto') and Mod(data) then
...
elseif Text and Text:match('(.*)/unlockkikedme') and Mod(data) then
...
elseif Text and Text:match('(.*)/unlockgames') and Mod(data) then
...
elseif Text and Text:match('(.*)/unlockrepgr') and Mod(data) then
...
elseif Text and Text:match('(.*)/homeaddrem') and Mod(data) then
...
elseif Text and Text:match('(.*)/lockchat') and Mod(tahaj) then
...
elseif Text and Text:match('(.*)/lockedit') and Mod(tahaj) then
...
{{text = 'تواصل سورس', url="t.me/uu_ban25BOT"}},
{{text = 'قناة البرمجة ', url="t.me/s_o_op"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مبرمج باندا', url="t.me/uu_ban"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'الالعاب المتطوره' then
local Text = [[
SOURCE SOON
]]
...
send(msg.chat_id_, msg.id_, " 𖡞 لا يمكنك حظر المطور باندا\n")
return false 
end
if result.sender_user_id_ == tonumber(1593178008) then
send(msg.chat_id_, msg.id_, " 𖡞 لا يمكنك حظر المطور حودا \n")
return false 
end
...
if result.sender_user_id_ == tonumber(1593178008) then
send(msg.chat_id_, msg.id_, " 𖡞 لا يمكنك كتم المطور حودا\n")
return false 
end
if result.sender_user_id_ == tonumber(1366055467) then
send(msg.chat_id_, msg.id_, " 𖡞 لا يمكنك كتم المطور باندا\n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
usertext = '\n 𖡞 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖡞 تم الغاء (الحظر-الكتم) عام من الجروبات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
send(msg.chat_id_, msg.id_," 𖡞 عذرا الملف لايدعم سورس سون \n") 
end
return false
end
...
send(msg.chat_id_, msg.id_," 𖡞 منشئ الجروب » ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
send(msg.chat_id_, msg.id_, ' 𖡞 تم مسح جميع المتوحدين')
end
if text == ("تاك للمتوحدين") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n 𖡞 قائمة متوحدين الجروب \nٴ≪┉ ┉ ┉ ┉ ┉ 𝙨𝙤𝙤𝙣 ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
local  statuss  = '\n 𖡞 تم رفع العضو متوحد في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖡞 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖡞 تم تنزيل العضو متوحد في الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖡞 تم مسح جميع الزوجات')
end
if text == ("تاك للزوجات") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n 𖡞 قائمه زوجات الجروب \nٴ≪┉ ┉ ┉ ┉ ┉ 𝙨𝙤𝙤𝙣 ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
local  statuss  = '\n 𖡞 تم رفع العضــو زوجه في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
status  = '\n 𖡞 تم تنزيل العضــو الزوجات من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖡞 تم مسح جميع الكلاب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖡞 العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖡞 تم رفع العضــو كلب في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖡞 العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖡞 تم تنزيل العضــو كلب من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖡞 تم تنزيل جميع حمير من الجروب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖡞 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n 𖡞 تم رفع المتهم حمار بالجروب\n 𖡞 الان اصبح حمار الجروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖡞 تم تنزيل جميع وتكات الجروب')
end
if text == ("تاك للوتكات") and Mod(msg) then
local list = database:smembers(bot_id..'Motte:User'..msg.chat_id_)
t = "\n 𖡞 قائمة وتكات الجروب \nٴ≪┉ ┉ ┉ ┉ ┉ 𝙨𝙤𝙤𝙣 ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_, ' 𖡞 تم تنزيل جميع القرده بالجروب')
end
if text == ("تاك للقرود") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n 𖡞 قائمة القرود الجروب \nٴ≪┉ ┉ ┉ ┉ ┉ 𝙨𝙤𝙤𝙣 ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_, ' 𖡞 تم تنزيل جميع البقرات بالجروب')
end
if text == ("تاك للبقرات") and Mod(msg) then
local list = database:smembers(bot_id..'Bakra:User'..msg.chat_id_)
t = "\n 𖡞 قائمة البقرات الجروب \nٴ≪┉ ┉ ┉ ┉ ┉ 𝙨𝙤𝙤𝙣 ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_, ' 𖡞 تم تنزيل جميع المزز بالجروب')
end
...
send(msg.chat_id_, msg.id_, ' 𖡞 تم تنزيل جميع االاكساس')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖡞  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖡞  الايدي » `'..result.sender_user_id_..'`\n 𖡞  تم تنزيله ادمن من الجروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
' }\n'..' 𖡞  الردود » { '..rdmder..
' }\n'..' 𖡞  الردود العامه » { '..rdsudo..
' }\n'..' 𖡞  الايدي » { '..idgp..
' }\n'..' 𖡞  الايدي بالصوره » { '..idph..
' }\n'..' 𖡞  الرفع » { '..setadd..
' }\n'..' 𖡞  الحظر » { '..banm..' }\n\nٴ≪┉ ┉ ┉ ┉ ┉ 𝙨𝙤𝙤𝙣 ┉  ┉ ┉ ┉ ┉≫ٴ\n 𖡞 قناة سورس سون ↓\n [🖨┇SOURCE 𝙨𝙤𝙤𝙣](t.me/s_o_op) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_,' 𖡞 تم ازالة صورة الجروب') 
end
return false  
end
...
send(msg.chat_id_, msg.id_,' 𖡞 تم تفعيل ترحيب الجروب') 
return false  
end
...
send(msg.chat_id_, msg.id_,' 𖡞 تم تعطيل ترحيب الجروب') 
return false  
end
if text == 'مسح الترحيب' or text == 'حذف الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' 𖡞 تم ازالة ترحيب الجروب') 
end
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, " 𖡞 لا توجد بوتات في الجروب")
else
...
send(msg.chat_id_, msg.id_," 𖡞 تم حفظ قوانين الجروب") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
if Mod(msg) then
send(msg.chat_id_, msg.id_," 𖡞 تم ازالة قوانين الجروب")  
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'𖡞تستطيع التنظيف 1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 𖡞 ليست لدي صلاحية تغير اسم الجروب")  
else
sebd(msg.chat_id_,msg.id_,' 𖡞 تم تغيير اسم الجروب الى {['..Name..']}')  
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_," 𖡞 تم مسح الردود العامه")
end

if text == ("الردود العامه") and DevSoFi(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n 𖡞 قائمة الردود العامه \nٴ≪┉ ┉ ┉ ┉ ┉ 𝙨𝙤𝙤𝙣 ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_," 𖡞 تم مسح الردود")
end
...
send(msg.chat_id_, msg.id_,'𖡞لا يمكنني تعديل  او وضع لقب ليس لدي صلاحيه\n 𖡞قم بترقيتي جميع الصلاحيات او صلاحية اضافه مشرف ') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n𖡞 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..') '
status  = '\n𖡞 الايدي » '..result.sender_user_id_..'\n𖡞تم ضافه {'..timsh..'} كلقب له'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
...
send(msg.chat_id_, msg.id_,'𖡞وينك وين القب ') 
else
send(msg.chat_id_, msg.id_,'𖡞لقبك هو : '..GeId.result.custom_title) 
end
end
...
send(msg.chat_id_, msg.id_,'\n 𖡞صلاحيات البوت هي\nٴ≪┉ ┉ ┉ ┉ ┉ 𝙨𝙤𝙤𝙣 ┉  ┉ ┉ ┉ ┉≫ٴ\n𖡞  علامة ال {✔️} تعني مفعل\n𖡞  علامة ال {✖} تعني غير مفعل\nٴ≪┉ ┉ ┉ ┉ ┉ 𝙨𝙤𝙤𝙣 ┉  ┉ ┉ ┉ ┉≫ٴ\n𖡞تغير معلومات المجموعة ↞ '..INf..'\n𖡞حذف الرسائل ↞ '..DEL..'\n𖡞حظر المستخدمين ↞ '..REs..'\n𖡞دعوة المستخدمين ↞ '..INv..'\n𖡞ثتبيت الرسالة ↞ '..Pin..'\n𖡞اضافة مشرفين ↞ '..PRo)   
end
end
...
local t = "\n𖡞المستخدم ~ ["..User_id .."] يصيح المشرفين \nٴ≪┉ ┉ ┉ ┉ ┉ 𝙨𝙤𝙤𝙣 ┉  ┉ ┉ ┉ ┉≫ٴ\n"
k = 0
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سون').." غادر" or text == 'بوت غادر' then  
if Sudo(msg) and not database:get(bot_id..'Left:Bot'..msg.chat_id_)  then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,' 𖡞 تم مغادرة الجروب') 
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
end
return false  
end
...
Text = '\n 𖡞 تم تفعيل الردود العامه' 
else
Text = '\n 𖡞 بالتاكيد تم تفعيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖡞 تم تعطيل الردود العامه' 
else
Text = '\n 𖡞 بالتاكيد تم تعطيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
'\n\n 𖡞 عدد رسائل الجروب : '..(msg.id_/2097152/0.5)..
'\n\n 𖡞  اسم الجروب : ['..ta.title_..']'
...
send(msg.chat_id_, msg.id_,' 𖡞 عذرا لا استطيع طرد ادمنية الجروب') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(msg.chat_id_, msg.id_,' 𖡞 تم طردك من الجروب') 
...
send(msg.chat_id_, msg.id_,' 𖡞 انت منشئ الجروب') 
return false
end
...
keyboard.inline_keyboard = {
{
{text = 'C1', callback_data="/help1"},{text = 'C2', callback_data="/help2"},{text = 'C3', callback_data="/help3"},
},
{
{text = 'C4', callback_data="/help4"},{text = 'C5', callback_data="/help5"},
},
{
{text = 'C6', callback_data="/help6"},{text = 'C7', callback_data="/help7"},{text = 'C8', callback_data="/help8"},
},
{
{text = 'C9', callback_data="/help9"},{text = 'C10', callback_data="/help10"},
},
{
...
if text == 'اوامر التعطيل' and Mod(msg) then
local Texti = 'تستطيع تعطيل وتفعيل عبر الازرار'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
ٴ┉ ┉ ┉ ┉ ┉ 𝙨𝙤𝙤𝙣 ┉ ┉ ┉ ┉  ┉ٴ
𖡞استعاده الاوامر 
𖡞تحويل كالاتي~⪼ بالرد على صوره او ملصق او صوت او بصمه بالامر ← تحويل 
𖡞صيح ~ تاك ~ المميزين : الادمنيه : المدراء : المنشئين : المنشئين الاساسين